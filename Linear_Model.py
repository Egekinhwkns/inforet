...
def LinearFonk():
    ...
    # head ilk 5 değeri direkt gösteriyor
    print(price.head())
    print(data.head())

    #Train ve test kümesini ayırdım.
    x_train, x_test,y_train,y_test = train_test_split(data,price,test_size=0.33, random_state=0) # %33 ile test yapılır &67 ile eğitilir
